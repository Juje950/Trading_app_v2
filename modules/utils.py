...
from config import MONEDAS_FRECUENTES, EXCHANGES_DISPONIBLES
...
class AppUtils:
    ...
    def validate_trade_form(fecha, moneda, exchange, ganancia):
        """Valida los datos del formulario de trades"""
        errors = []
    ...
    def validate_capital_form(nombre, monto, fecha, tipo):
        """Valida los datos del formulario de capital"""
        errors = []
    ...
    def update_currencies_list(new_currency):
        """Actualiza la lista de monedas frecuentes"""
        if new_currency and new_currency not in MONEDAS_FRECUENTES:
    ...
    def get_current_datetime():
        ...
        return datetime.now(timezone('America/Argentina/Buenos_Aires'))
    ...
    def display_dataframe(df, columns_to_format=None):
        """Muestra un DataFrame de pandas en Streamlit con formato"""
